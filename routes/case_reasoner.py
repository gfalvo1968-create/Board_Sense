"""SPIKE Multi-Photo Case Reasoner v0.8."""
...
def reconcile_case(results):
 ...
 combined["model"]="Board Sense v3.1 + SPIKE Multi-Photo Case Reasoner v0.8 + Same-Board Verification Gate v0.3 + Physical Fingerprint v0.2 + Decision Guard v0.3 + Condition & Harvest v0.2 + Recovery Economics v0.2";return combined
