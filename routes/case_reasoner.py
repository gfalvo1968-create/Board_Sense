"""SPIKE Multi-Photo Case Reasoner v0.23."""
...
def reconcile_case(results):
 ...
 combined["three_answers"]=_three_answers(combined,identity,condition,combined["recovery_economics"]);combined["model"]="Board Sense v4.2 + SPIKE Multi-Photo Case Reasoner v0.23 + Same-Board Verification Gate v1.1 + Physical Fingerprint v0.3 + SPIKE Vision v1.6 + Strict Edge Contact Geometry v0.2 + Reference Reasoner v5 + Board Blueprint v1.0 + Power Topology v0.3 + Motherboard Detector v0.3 + Cross-View Harvest Corroborator v0.1 + Decision Guard v0.3 + Equipment Subtype v0.3 + Recovery Grade Guard v0.5 + Condition & Harvest v0.3 + Recovery Economics v0.2";return combined
