"""SPIKE Multi-Photo Case Reasoner v0.12."""
...
def reconcile_case(results):
 ...
 combined["three_answers"]=_three_answers(combined,identity,condition,combined["recovery_economics"]);combined["model"]="Board Sense v3.5 + SPIKE Multi-Photo Case Reasoner v0.12 + Same-Board Verification Gate v0.6 + Physical Fingerprint v0.3 + Cross-View Harvest Corroborator v0.1 + Decision Guard v0.3 + Equipment Subtype v0.3 + Recovery Grade Guard v0.3 + Condition & Harvest v0.2 + Recovery Economics v0.2";return combined
