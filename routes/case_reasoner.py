...
def reconcile_case(results):
 ...
 if identity.get("block_reconciliation"):
  clarification=identity.get("status")=="IDENTITY_CLARIFICATION_NEEDED"
  answer="Identity Clarification Required" if clarification else "Multiple Boards / Case Split Required"
