"""SPIKE Multi-Photo Case Reasoner v0.9."""
...
def reconcile_case(results):
 ...
 unique=len(signatures);combined["same_board_verification"]=identity;combined["case_analysis"]={"mode":"same_board_multi_photo","views_analyzed":len(results),"independent_evidence_patterns":unique,"view_summaries":view_summaries,"identity_gate":identity,"duplicate_evidence_guard":{"active":True,"rule":"Repeated equivalent views corroborate but do not multiply authority at full weight. Structural geometry is part of the evidence signature."},"condition_reconciliation":{"active":True,"rule":"A feature visible in one view defeats mere not-visible evidence in another. Only confirmed physical removal creates a deduction."},"message":"Case identity was checked before evidence reconciliation. Confirmed structural geometry outranks repeated weak hints; view diversity outranks photo count."}
