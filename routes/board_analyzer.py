...
def analyze_board(image_path):
 ...
 # A broad gold-colour patch near an edge is only an inspection cue. Promotion
 # to gold fingers requires repeated edge-contact geometry from Board Visual.
